...
def create_analysis_dashboard(
    ...
    match_score = match_analysis.get("match_score", 0) if match_analysis else 0
    ...
    with col2:
        ...
        if decision:
            with st.container():
                ...
                # Display key strengths and concerns
                if "rationale" in decision:
                    ...
                    with col1:
                        ...
                        for strength in decision["rationale"].get("key_strengths", [])[:3]:
                            st.markdown(f"- {strength}")
                    
                    with col2:
                        st.markdown("##### Concerns")
                        for concern in decision["rationale"].get("concerns", [])[:3]:
